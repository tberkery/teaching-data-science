...
* You can (and typically should) still use the piping operator with a function that takes mulitple arguments. Just understand that you can only pipe one argument into the function.
