...
## `SUMMARIZE`
Imagine that I want to compute the average statistical profile by team for 2023. I can do this using effective grouping strategies on my 2023 batting leaderboard data.
...
An interesting note is that there is actually another way we could have assembled this summary by team using a function called `summarize`. I find that this can be more complex to write but much cleaner and faster sometimes if written correctly.
